...
@section('meta-img') {{ asset('/storage/images/avatars/'.$user->avatar) }} @endsection
...
@endif
<h1>
    <img src="/storage/images/avatars/{{ $user->avatar }}" style="width:125px; height:125px; float:left; border-radius:50%; margin-right:25px;" alt="{{ $user->name }}" >
    {!! $user->displayName !!}
    ...
    <div class="row mb-4">
        @foreach($chunk as $character)
            <div class="col-md-3 col-6 text-center">
                <div>
                    <a href="{{ $character->url }}"><img src="{{ $character->image->thumbnailUrl }}" class="img-thumbnail character-profile-thumbnail" alt="{{ $character->fullName }}" /></a>
                </div>
                <div class="mt-1">
