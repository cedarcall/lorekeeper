<div class="card mb-3 news-card">
    <div class="card-header">
        ...
        <small>
            Posted {!! $news->post_at ? pretty_date($news->post_at) : pretty_date($news->created_at) !!} :: Last edited {!! pretty_date($news->updated_at) !!} by {!! $news->user ? $news->user->displayName : 'Unknown' !!}
        </small>
    </div>
    <div class="card-body">
